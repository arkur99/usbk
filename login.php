...
<html class="no-js" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title><?php echo $skull;?> | Computer Based Test</title>
	<script language="JavaScript">
		var txt="<?php echo $skull;?> - Computer Based Test   - ";
...
<div class="group">
    <div class="left" style="background-color:<?php echo "$warna"; ?>">
    	<?php 
if(!$val == FALSE) {?><img src="images/<?php echo $banner; ?>" style=" margin-left:0px;"><?php 
}
?></div>
    	<div class="right">
			<table width="100%" border="0" style="margin-top:10px">   
				...
				<tr><td><span class="user">&nbsp;</span></td></tr>
				<tr><td><span class="log"><a href="logout.php">&nbsp;</a><span></td></tr>
			</table>
        </div>
...
<div class="panel panel-default" style="margin-top:20px">
	...
	<?php 
if(!$val == FALSE) {?>	<img src="images/<?php echo  $logo  ?>" style=" width:17%; margin-top:-5px; overflow:hidden "/><?php 
}
?>
...
<div style="margin-top:130px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
    <div class="content">
        CBT.Application.Web:<strong>3.0</strong><br>
        CBT.Baseclass:<strong>2.0</strong><br>
        CBT.Sync:<strong>3.0</strong><br>
    </div>
</div>
<footer>
    <div class="container" style=" font-size:12px">
        <p>Copyright &copy; 2018 - CBT Application All Rights Reserved | <?php echo $skull;?></p>
    </div>
</footer>
