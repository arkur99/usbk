...
//get next picture id
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id FROM pictures WHERE id > '$current_picture' ORDER BY id ASC LIMIT 1");
...
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT id FROM pictures WHERE id < $current_picture ORDER BY id DESC LIMIT 1");
$result = mysqli_fetch_array($sql);
if($result){
	$prev_id = $result['id'];
}
...
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT PictureTitle, PictureName FROM pictures WHERE id = $current_picture LIMIT 1");
$result = mysqli_fetch_array($sql);
if($result){
