                        ...
                        if ($(this).attr('href')!== window.location.hash){
                            ...
                            if (href !== undefined && !(href.match(/^#/) || href.trim() == '')) {
                                ...
                                if (cekurl == 0 || cekurl === null || cururl == State.url){
                                    $("#sidebar").append("<div id='loadingbar'></div>").find("#loadingbar").animate({width:'100%'},1800).fadeOut(1000);
...
function cek_persiapan(id_ujian)
{
    var cek_agree = document.getElementById('cek_agree_'+id_ujian);
    if(cek_agree.checked == true) 
    {
        $('#button-agree-'+id_ujian).removeClass('disabled');
    }
    else
    {
        $('#button-agree-'+id_ujian).addClass('disabled');
    }
}
