...
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "Update cbt_siswa_ujian set XLastUpdate = '$tgl' where XNomerUjian = '$user' and XStatusUjian = '1' ");
}
//cek data siswa ujian
  $sqluser = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  `cbt_siswa` s LEFT JOIN cbt_ujian u ON s.XKodeKelas = u.XKodeKelas WHERE XNomerUjian = 
...
$sqlceksiswa = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_siswa_ujian where XNomerUjian = '$user' and XKodeSoal = '$xkodesoal'  and XTokenUjian = '$xtokenujian'"); 
