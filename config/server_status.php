...
$status_konek = "1";
mysqli_select_db( $link, $database) or die('<b><span style="color: #ff0000;">SERVER tidak terhubung ke DataBase SERVER PUSAT</span><br><br>SOLUSI : <br></br>Edit koneksi database CBTSync dengan tepat</b> >> Langkah :
...
//mysql_select_db("CBTSync", $sqlconn);
