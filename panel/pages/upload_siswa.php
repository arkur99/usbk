...
<div style="width: 20%; float:left">
   <a href="../../file-excel/CBTSync_Siswa_Template.xls" target="_blank"><img src="images/xls.png" style=" width:90%; max-width:100px;padding-right:10px;"/></a>
</div>
...
<div style="width: 80%; float:right">
   ...
   database melalui tool dibawah ini. 
                        ...
                        <div class="panel-footer">
                                   <a href="../../file-excel/CBTSync_Siswa_Template.xls" target="_blank"><button class="btn btn-success btn-lg btn-small" id="baru" value="Buat" name="baru"><i class="fa fa-cloud-download"></i>
