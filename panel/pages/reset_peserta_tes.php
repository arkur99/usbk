...
<body>
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Reset Login Peserta</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php 
$no=0;
$sql = mysql_query("select u.*,m.*,p.*, u.Urut as Urutan,u.XKodeSoal as XKodeSoal, u.XSesi as XSesi,u.XKodeKelas as kokel from cbt_ujian u left join cbt_mapel m on m.XKodeMapel = u.XKodeMapel 
 ...
 $.ajax({
	 ...
	 location.reload();
		//tampildata();
                                    ...
                                    <tr class="odd gradeX">
                                        <td><input type="hidden" value="<?php echo $s['Urutan']; ?>" id="txt_mapel<?php echo $s['Urutan']; ?>"><?php echo $no; ?>
										...
										<button class="btn btn-danger" ><?php echo "Reset Login"; ?></button></a>
										</td>
