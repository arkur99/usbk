...
if($jumcek<1){
			...
			(XKodeMapel,XLevel,XKodeSoal,XJumPilihan,XJenis,XTglBuat,XGuru,XKodeKelas,XKodeJurusan,XJumSoal,XPilGanda,XEsai,XPersenPil,XPersenEsai,XKodeSekolah) values 			
			('$_REQUEST[txt_mapelx]','$_REQUEST[txt_levelx]','$_REQUEST[txt_namax]','$_REQUEST[txt_jawabx]','$_REQUEST[txt_jenisx]','$tgl',			
