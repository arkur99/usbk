...
<html>
  <head>
    <title>Computer Based Test - CBT | Administrator</title>
</head>
  <body>
<!--
...
//alert(txt_mapel);   
 $.ajax({
     ...
     data: "aksi=simpan&txt_ujian=" + txt_ujian + "&txt_jawab=" + txt_jawab + "&txt_jenis=" + txt_jenis + "&txt_kelas=" + txt_kelas + "&txt_jurusan=" + txt_jurusan + 
                ...
                <div class="panel-body">
                    <table width="100%" border="0px">
                        ...
                        <tr height="32px">
							...
							<td>: 	&nbsp;
							<td><select class="form-control" id="txt_jenisz">
