                ...
                <div class="col-md-12">
                            <div class="portlet light ">
                                <div class="portlet-title">
									...
									<div class="actions">
										<a href="../../file-excel/CBTSync_Tugas_Template.xls" target="_blank">
...
<div style="width: 20%; float:left">
   <a href="../../file-excel/CBTSync_Tugas_Template.xls" target="_blank"><img src="images/xls.png" style=" width:90%; max-width:100px;padding-right:10px;"/></a>
</div>

<div style="width: 80%; float:right">
   Silahkan Klik logo Excel disamping, untuk <a href="../../file-excel/CBTSync_Tugas_Template.xls" target="_blank"> download </a> file excel database tugas. 
